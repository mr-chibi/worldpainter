...
execute if score @s paint_custom_biome_active_pages matches 1 run function mc_schematics:mr_chibis/biomes/default
execute if score @s paint_custom_biome_active_pages matches 2 run function mc_schematics:mr_chibis/biomes/enhanced
