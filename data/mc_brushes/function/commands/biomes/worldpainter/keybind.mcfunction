...
execute if score @s[scores={paint_custom_biome=1..18}] paint_custom_biome_active_pages matches 1 run function mc_brushes:commands/biomes/worldpainter/pages/default
execute if score @s[scores={paint_custom_biome=19..34}] paint_custom_biome_active_pages matches 2 run function mc_brushes:commands/biomes/worldpainter/pages/enhanced
