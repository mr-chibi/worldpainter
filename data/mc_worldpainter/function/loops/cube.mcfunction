#
execute as @e[type=minecraft:armor_stand,distance=..32,tag=paint_cube,sort=nearest] at @s as @p at @s run function mc_worldpainter:commands/blocks/setblock

#
# execute as @e[type=minecraft:armor_stand,distance=..32,tag=paint_cube,sort=nearest] at @s run particle minecraft:end_rod ~ ~ ~ 0.25 0.75 0.50 0 50
