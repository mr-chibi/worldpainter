#
execute as @e[type=minecraft:armor_stand,distance=..32,tag=paint_walls_x1,sort=nearest] at @s as @p at @s run function mc_worldpainter:commands/blocks/setblock
