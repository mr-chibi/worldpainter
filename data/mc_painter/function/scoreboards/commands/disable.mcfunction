...
#
scoreboard players reset @s paint_biome_pages
scoreboard players reset @s paint_custom_biome_pages
scoreboard players reset @s paint_schematic_pages
scoreboard players reset @s paint_sphere_pages
scoreboard players reset @s paint_smooth_pages
scoreboard players reset @s paint_position_pages