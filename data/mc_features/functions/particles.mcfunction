...
execute as @s[tag=colorSchematics,scores={paint_schematic=5}] run function mc_schematics:mr_chibis/place/mud/particles
execute as @s[tag=colorSchematics,scores={paint_schematic=6}] run function mc_schematics:mr_chibis/place/stone/particles
...
# Toggle / Reset
############################################################
execute if block ~ ~ ~ minecraft:air positioned ^ ^ ^1 positioned ^ ^0.10 ^ run function mc_features:particles